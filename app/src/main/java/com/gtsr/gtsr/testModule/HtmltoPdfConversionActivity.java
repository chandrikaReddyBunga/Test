    ...
    private void init() {
        ...
        export.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String fileNmae1 =  "UrineTestReport" + "_" + date + ".pdf";
                fileName = fileNmae1;
    ...
    public String renderTestReport(String htmlPath, String date, String patientName, String gender, String age, String clientID) {
        try {
          ...
          //  }
            ...
            htmlContentString = htmlContentString.replace("#REPORT_DATE#", UrineResultsDataController.getInstance().convertTimestampTodate(String.valueOf(System.currentTimeMillis() / 1000L)));
...
//<td><span style="color:red">#R_VALUES#</span></td>
                for (TestFactors objTestFactor : TestFactorDataController.getInstance().testfactorlist) {
                    String oneItemsHtmlString = "<tr class='table-row'><td><span>#S_NO#</span></td><td><span>#TEST_NAME#</span></td><td><span>#TEST_VALUE#</span></td><td><span>#RANGE_LINE#</span></td><td><span>#TEST_UNIT#</span></td><td>#IMAGE_LINK#</td><td><span>#REFERENCE_RANGE#</span></td></tr>";
            ...
            htmlContentString = htmlContentString.replace("UNIT", LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.UNIT_KEY));
            htmlContentString = htmlContentString.replace("REFERENCE RANGE", LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.REFERENCE_RANGE_KEY));
            ...
            htmlContentString = htmlContentString.replace("Phone", LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.PHONE_KEY));
